...
set shortmess=aoO
badd +1 arcilab.xtm
badd +1 roll/roll.xtm
badd +1 roll/passes.xtm
badd +1 roll/pass1.xtm
badd +1 roll/pass2.xtm
badd +1 roll/pass3.xtm
badd +1 roll/pass4.xtm
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((24 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 25 - ((23 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 746 - ((53 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
746
