...
silent only
cd ~/Coding/extempore/arcilab/roll
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 656 - ((42 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
656
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 85 - ((31 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 81 - ((55 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
81
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((28 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
