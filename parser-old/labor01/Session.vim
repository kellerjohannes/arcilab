...
badd +0 1_4Komma/Spekulative_Intonationspraxis_2_1_4Komma_nicht_transp_I.xtm
badd +0 1_4Komma/vicentino_madonna_1_4_Komma_trans_rev.xtm
badd +0 1_4Komma/vicentino_soave_1_4_Komma_trans_rev.xtm
argglobal
silent! argdel *
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 288 - ((2 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
288
